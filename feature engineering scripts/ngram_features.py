...
bigrams = pd.DataFrame(cv_mat.todense(), index=data['index'], columns=cv.get_feature_names_out())
...
char_bigrams = pd.DataFrame(cv_char_mat.todense(), index=data['index'], columns=cv_char.get_feature_names_out())
...
tf_idf =pd.DataFrame(transformed_weights.todense(), index=data['index'], columns=cv.get_feature_names_out())
